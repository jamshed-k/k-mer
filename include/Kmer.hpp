...
public:
    ...
    Kmer(const char* const label, const size_t kmer_idx);
    ...
    static void set_k(const uint16_t kmer_len);
    ...
    void roll_to_next_kmer(const char next_nucl, Kmer<k>& rev_compl);
